...
const DATA: Record<string, Article[]> = {
  ...
  calculators: [
    { href: "/calculators/sip",                       cat: "Calculator",     wm: "SIP",    bg: "linear-gradient(135deg,#064e3b 0%,#059669 100%)",             title: "SIP Calculator — See exactly how ₹5,000/month grows over 10 years",                         date: "Updated May 2026", read: "Free tool" },
    { href: "/calculators/emi",                       cat: "Calculator",     wm: "EMI",    bg: "",                                                            title: "EMI Calculator — Home loan, car loan, personal loan monthly outgo",                          date: "Updated May 2026", read: "Free tool" },
    { href: "/calculators/tax",                       cat: "Calculator",     wm: "Tax",    bg: "linear-gradient(135deg,#78350f 0%,#d97706 100%)",             title: "Tax Regime Comparator — Old vs New for your exact salary in FY 2025–26",                    date: "Updated May 2026", read: "Free tool" },
    { href: "/calculators/education-corpus",          cat: "Calculator",     wm: "Edu",    bg: "linear-gradient(135deg,#831843 0%,#db2777 100%)",             title: "Education Corpus Calculator — How much to save for your child's college in 2033",            date: "Updated May 2026", read: "Free tool" },
    { href: "/calculators/term-cover",                cat: "Calculator",     wm: "Term",   bg: "linear-gradient(135deg,#3b0764 0%,#7c3aed 100%)",             title: "Term Cover Estimator — How much life insurance does your family actually need?",             date: "Updated May 2026", read: "Free tool" },
    { href: "/calculators/ppf",                       cat: "Calculator",     wm: "PPF",    bg: "linear-gradient(135deg,#0c4a6e 0%,#0284c7 100%)",             title: "PPF Maturity Calculator — Returns, partial withdrawal, and tax savings",                     date: "Updated May 2026", read: "Free tool" },
  ],
};
